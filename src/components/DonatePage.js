...
export default function Hero() {
    ...
    return (
        ...
        <Flex direction="column" marginBottom={'20%'} id='home'> 
            <Image objectFit={{base:'cover',md:'fill'}} src={'https://ik.imagekit.io/cw8gn2alz/donate_bg.png'} alt='Main SVG' position={'absolute'} w={{base:'auto',md:'100%'}} h={{base:'112vw',md:'86vw',lg:'54vw'}} top='0' zIndex={-2}></Image>
