import { Flex, Text, FormControl, FormLabel, Button, FormHelperText,InputGroup, Input, InputLeftAddon , Textarea, Image,
        FormErrorMessage, Modal, ModalOverlay, ModalContent, ModalCloseButton, useDisclosure, Select } from '@chakra-ui/react'
...
export default function Registration() {
    ...
    const templateID = 'template_xn89x4s';
    ...
    const handleSubmit = (e) => {
        ...
        let addError = values.address.length >= 10;
        let fatherError = values.father.length > 0;
        let classError = values.class.length > 0;
        let schoolError = values.school.length > 0;
        let dobError = values.dob.length > 0;
        setValues({
            ...values,
            nameInvalid: !nameError,
            phoneInvalid: !phoneError,
            emailInvalid: !emailError,
            addressInvalid: !addError,
            fatherInvalid: !fatherError,
            classInvalid: !classError,
            schoolInvalid: !schoolError,
            dobInvalid: !dobError,
        })
        if( !values.nameInvalid && !values.phoneInvalid && !values.emailInvalid && !values.addInvalid && !values.fatherInvalid && !values.classInvalid&& !values.schoolInvalid&& !values.dobInvalid){
    ...
    return (
        ...
        <Flex direction={{base:'column-reverse',md:'row'}} align='center' justify='space-around' mt='10'>
            ...
            <Flex direction='column' align='flex-start' justify='space-around' color='white' data-aos='fade-left'>
                <Text fontSize='5xl' my='3' fontWeight='semibold' color='blue.800'>Registration Form</Text>
                <form>
                    ...
                    <FormControl id="father" mr='4' isRequired isInvalid={values.fatherInvalid}>
                            <FormLabel color='#135EAD'>Father's Name</FormLabel>
                            <Input type="text" bg="#135EAD" boxShadow='xl' name='father' value={values.father} onChange={handleInputChange}/>
                            <FormErrorMessage>Father's Name is empty</FormErrorMessage>
                    </FormControl>
                    <FormControl id="school" mr='4' isRequired isInvalid={values.schoolInvalid}>
                            <FormLabel color='#135EAD'>School Name</FormLabel>
                            <Input type="text" bg="#135EAD" boxShadow='xl' name='school' value={values.school} onChange={handleInputChange}/>
                            <FormErrorMessage>School Name is empty</FormErrorMessage>
                    </FormControl>
                    <Flex direction={{base:'column',md:'row'}} justify='space-around'>
                        <FormControl id="class" mr='4' isRequired isInvalid={values.classInvalid}>
                            <FormLabel color='#135EAD'>Class</FormLabel>
                            <Input type="text" bg="#135EAD" boxShadow='xl' name='class' value={values.class} onChange={handleInputChange}/>
                            <FormErrorMessage>Class is empty</FormErrorMessage>
                        </FormControl>
                        <FormControl id="dob" isInvalid={values.dobInvalid}>
                            <FormLabel color='#135EAD'>Date Of Birth</FormLabel>
                                <Input type="date" bg="#135EAD" boxShadow='xl' name='dob' value={values.dob} onChange={handleInputChange}/>
                            <FormErrorMessage>DOB is invalid</FormErrorMessage>
                        </FormControl>
                    </Flex>
                    <FormControl id="mode" mr='4' isRequired >
                            <FormLabel color='#135EAD'>Exam Mode</FormLabel>
                            {/* <Input type="text" bg="#135EAD" boxShadow='xl' name='mode' value={values.mode} onChange={handleInputChange}/> */}
                            <Select bg="white" color='#135EAD' boxShadow='xl' name='mode' value={values.mode} onChange={handleInputChange} >
                                <option > Offline</option>
                                <option >Proctored Online</option>
                            </Select>
                    </FormControl>
                    ...
                    <FormControl id="address" isRequired isInvalid={values.addInvalid} >
                        <FormLabel color='#135EAD'>Address</FormLabel>
                        <Textarea bg="#135EAD" boxShadow='xl' name='address' value={values.address} onChange={handleInputChange}/>
                        <FormErrorMessage>Address should be in greater than 1 characters</FormErrorMessage>
                    </FormControl>
